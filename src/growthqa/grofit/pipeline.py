            ...
            gc_boot_rows.append(
                {
                    ...
                    "sd.mu.bt": _boot_val("mu", "std"),
                    "ci90.mu.bt.lo": _boot_val("mu", "lo90"),
                    "ci90.mu.bt.up": _boot_val("mu", "hi90"),
                    "ci95.mu.bt.lo": _boot_val("mu", "lo"),
                    "ci95.mu.bt.up": _boot_val("mu", "hi"),
                    "lambda.bt": _boot_val("lag", "mean"),
                    "sdlambda.bt": _boot_val("lag", "sd"),
                    "sd.lambda.bt": _boot_val("lag", "std"),
                    "ci90.lambda.bt.lo": _boot_val("lag", "lo90"),
                    "ci90.lambda.bt.up": _boot_val("lag", "hi90"),
                    "ci95.lambda.bt.lo": _boot_val("lag", "lo"),
                    "ci95.lambda.bt.up": _boot_val("lag", "hi"),
                    "A.bt": _boot_val("A", "mean"),
                    "sdA.bt": _boot_val("A", "sd"),
                    "sd.A.bt": _boot_val("A", "std"),
                    "ci90.A.bt.lo": _boot_val("A", "lo90"),
                    "ci90.A.bt.up": _boot_val("A", "hi90"),
                    ...
                    "sd.integral.bt": _boot_val("integral", "std"),
                    "ci90.integral.bt.lo": _boot_val("integral", "lo90"),
                    "ci90.integral.bt.up": _boot_val("integral", "hi90"),
